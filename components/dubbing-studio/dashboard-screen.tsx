    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-foreground">{SAVPD_CONSTANTS.BRAND.TRADEMARK}</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-xl border border-border bg-card/60 text-muted-foreground transition hover:text-primary active:scale-95"
          >
...
function DashboardContent({
  ...
  return (
    <div className="relative flex flex-col gap-5">
      {/* 🌟 Header (ដកឈ្មោះ Brand កណ្ដាលចេញ — ទុកតែនៅលើកំពូលទំព័រ) */}

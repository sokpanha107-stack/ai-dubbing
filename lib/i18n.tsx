...
export const TRANSLATIONS: Record<LangCode, Strings> = {
  en: {
    ...
    contextDesc: "Meaning, phrasing and numbers stay accurate across all 5 languages.",
    ...
    languages: { en: "English", zh: "Chinese", km: "Khmer", th: "Thai", vi: "Vietnamese" },
  ...
  zh: {
    ...
    contextTitle: "语境守护",
    contextDesc: "词义、措辞和数字在全部 5 种语言中保持准确。",
    emotionTitle: "情感与音调",
    emotionDesc: "保留原声的笑声、愤怒、恐惧与喜悦。",
    paceTitle: "语速与节奏",
    paceDesc: "说话速度与原始视频保持同步。",
    featuresHeading: "AI 能力",
    languages: { en: "英语", zh: "中文", km: "高棉语", th: "泰语", vi: "越南语" },
    appearance: "外观",
    darkMode: "深色模式",
    lightMode: "浅色模式",
    eyeCare: "护眼（蓝光过滤）",
  ...
  km: {
    ...
    contextDesc: "អត្ថន័យ ឃ្លា និងលេខ នៅតែត្រឹមត្រូវគ្រប់ភាសាទាំង ៥។",
    ...
    languages: { en: "អង់គ្លេស", zh: "ចិន", km: "ខ្មែរ", th: "ថៃ", vi: "វៀតណាម" },
    appearance: "រូបរាង",
  ...
  th: {
    ...
    contextDesc: "ความหมาย ถ้อยคำ และตัวเลข ยังคงถูกต้องในทั้ง 5 ภาษา",
    ...
    languages: { en: "อังกฤษ", zh: "จีน", km: "เขมร", th: "ไทย", vi: "เวียดนาม" },
  ...
  vi: {
    ...
    contextDesc: "Ý nghĩa, cách diễn đạt và con số luôn chính xác trên cả 5 ngôn ngữ.",
    ...
    languages: { en: "Tiếng Anh", zh: "Tiếng Trung", km: "Tiếng Khmer", th: "Tiếng Thái", vi: "Tiếng Việt" },
